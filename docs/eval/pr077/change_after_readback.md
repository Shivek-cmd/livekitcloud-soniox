...
**SIERRA:** Great, no allergies or special requests noted. Would you like to pick up your order or have it delivered?

**USER:** Pickup.
> `set_order_type({"order_type": "pickup"})` → Set to pickup. Continue the flow.
**SIERRA:** Perfect, pickup it is. Can I have your name for the order, please?
...
**SIERRA:** Thanks, Jasleen. Could you please provide your phone number now?
...
**USER:** Yes, perfect.
**SIERRA:** Thank you! Have a great day!
