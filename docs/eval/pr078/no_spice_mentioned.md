...
**SIERRA:** Sure thing — I've got one Butter Chicken and one ਗਾਰਲਿਕ ਨਾਨ for you. Anything else you'd like with that?
...
**SIERRA:** ਬਿਲਕੁਲ ਜੀ, ਕੋਈ ਖਾਸ ਨਹੀਂ — all set with that. Would you like to pick up your order or have it delivered?

**USER:** Pickup.
> `set_order_type({"order_type": "pickup"})` → Set to pickup. Continue the flow.
**SIERRA:** Great, pickup it is. Can I have your name for the order, please?
...
**SIERRA:** Thanks, Karan. Could you please share your phone number as well?
...
**SIERRA:** Alright Karan, you have one Butter Chicken with medium spice and one ਗਾਰਲਿਕ ਨਾਨ for pickup. Does everything look good to you?
