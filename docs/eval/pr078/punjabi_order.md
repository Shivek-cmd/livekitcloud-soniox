...
**SIERRA:** ਕੋਈ ਗੱਲ ਨਹੀਂ ਜੀ, ਹੁਣ ਦੱਸੋ ਕਿ ਤੁਸੀਂ ਪਿਕਅਪ ਕਰਨਾ ਚਾਹੁੰਦੇ ਹੋ ਜਾਂ ਡਿਲਿਵਰੀ?
...
**SIERRA:** ਠੀਕ ਹੈ ਜੀ, ਮੀਡੀਅਮ spice ਤੇ ਕੋਈ allergy ਨਹੀਂ ਨੋਟ ਕਰ ਲਈ। ਹੁਣ ਦੱਸੋ ਜੀ, ਪਿਕਅਪ ਕਰਨਾ ਹੈ ਜਾਂ ਡਿਲਿਵਰੀ?

**USER:** Pickup ਜੀ।
> `set_order_type({"order_type": "pickup"})` → Set to pickup. Continue the flow.
**SIERRA:** ਵਧੀਆ ਜੀ, ਪਿਕਅਪ ਲਈ ਲਿਖ ਲਿਆ। ਹੁਣ ਤੁਹਾਡਾ ਨਾਮ ਦੱਸੋ ਜੀ।
...
**SIERRA:** ਗੁਰਪ੍ਰੀਤ ਜੀ, ਤੁਹਾਡੇ ਕੋਲ ਦੋ ਬਟਰ ਚਿਕਨ ਹਨ, ਮੀਡੀਅਮ spice ਨਾਲ, ਅਤੇ ਆਰਡਰ ਪਿਕਅਪ ਲਈ ਹੈ। ਇਹ ਸਾਰਾ ਠੀਕ ਹੈ ਜੀ?
