...
> `add_item({"item_query": "paneer tikka", "quantity": 1, "spice_level": "medium"})` → INTERNAL: item saved. ⏎ SAY EXACTLY: "Yes — one Paneer Tikka." ⏎ Do NOT mention price, cart, menu, pieces, or say I can add / I've added.
> `add_item({"item_query": "gulab jamun", "quantity": 1})` → INTERNAL: item saved. ⏎ SAY EXACTLY: "Yes — one ਗੁਲਾਬ ਜਾਮੁਨ." ⏎ Do NOT mention price, cart, menu, pieces, or say I can add / I've added.
**SIERRA:** Yes — one Paneer Tikka and one ਗੁਲਾਬ ਜਾਮੁਨ. Anything else?

**USER:** मीडियम ठीक है।
**SIERRA:** Yes — one Paneer Tikka medium and one ਗੁਲਾਬ ਜਾਮੁਨ. Anything else?

**USER:** बस, और कुछ नहीं।
**SIERRA:** Do you have any allergies we should know about?
