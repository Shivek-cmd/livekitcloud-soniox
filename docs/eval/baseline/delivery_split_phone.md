...
> `add_item({"item_query": "dal makhani", "quantity": 1, "spice_level": "medium"})` → INTERNAL: item saved. ⏎ SAY EXACTLY: "Yes — one ਦਾਲ ਮੱਖਣੀ." ⏎ Do NOT mention price, cart, menu, pieces, or say I can add / I've added.
> `add_item({"item_query": "butter naan", "quantity": 2})` → INTERNAL: item saved. ⏎ SAY EXACTLY: "Yes — two ਬਟਰ ਨਾਨ." ⏎ Do NOT mention price, cart, menu, pieces, or say I can add / I've added.
**SIERRA:** Yes — one ਦਾਲ ਮੱਖਣੀ and two ਬਟਰ ਨਾਨ. Anything else?

**USER:** Make the dal spicy.
> `set_item_spice({"item_query": "dal makhani", "spice_level": "spicy"})` → INTERNAL: spice updated. ⏎ SAY EXACTLY: "Sure — ਦਾਲ ਮੱਖਣੀ spicy." ⏎ Do NOT mention cart or menu.
**SIERRA:** Sure — ਦਾਲ ਮੱਖਣੀ spicy. Anything else?
...
**SIERRA:** Please provide your delivery address.
...
**SIERRA:** Please say the full phone number digit by digit.
...
**SIERRA:** Is your order for pickup or delivery?
