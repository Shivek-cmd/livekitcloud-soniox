...
> `add_item({"item_query": "garlic naan", "quantity": 1})` → INTERNAL: item saved. ⏎ SAY EXACTLY: "Yes — one ਗਾਰਲਿਕ ਨਾਨ." ⏎ Do NOT mention price, cart, menu, pieces, or say I can add / I've added.
**SIERRA:** Yes — two Butter Chicken. Yes — one ਗਾਰਲਿਕ ਨਾਨ. Anything else?
