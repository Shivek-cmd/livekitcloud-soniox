...
**SIERRA:** Sure thing — I've got two Butter Chicken and one Garlic Naan down for you. Anything else I can get you with that?
...
**SIERRA:** Great, thanks for letting me know. Would you like to pick this up, or should we deliver it for you?

**USER:** Medium spice is fine, and no allergies.
> `record_additional_requests({"response": "Medium spice, no allergies."})` → ADDITIONAL REQUESTS RECORDED for the kitchen: "Medium spice, no allergies.". ⏎ ORDER NOW: 2 x Butter Chicken [medium]; 1 x ਗਾਰਲਿਕ ਨਾਨ (Garlic Naan). total=$44.97 ⏎ GUIDE: acknowledge warmly in the customer's language, in your own words — do NOT re-ask about spice or allergies — then keep the order moving (pickup or delivery next if not set yet).
**SIERRA:** Got it, I've noted that for the kitchen. Would you like to pick this up, or should we deliver it for you?
...
**SIERRA:** Thanks, Harpreet. And could I have a phone number for the order, please?
...
**SIERRA:** Got it, Harpreet. So, I have two Butter Chicken at medium spice, one Garlic Naan, and this is for pickup. Is everything correct?
...
**SIERRA:** My apologies, Harpreet, let me just double-check that for you. I have two Butter Chicken at medium spice, one Garlic Naan, and this is for pickup under the name Harpreet. Is everything correct?
