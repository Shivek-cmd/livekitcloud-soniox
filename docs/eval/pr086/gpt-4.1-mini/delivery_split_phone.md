...
**SIERRA:** Alright, I've got one Dal Makhani and two Butter Naan for you. Anything else you'd like to add?
...
**SIERRA:** Got it, your Dal Makhani will be spicy. Anything else you'd like to add?

**USER:** That's all.
**SIERRA:** Great! Do you have any spice preferences, allergies, or special instructions for the kitchen?

**USER:** Nope, no allergies, nothing else.
> `record_additional_requests({"response": "no allergies, no special instructions"})` → ADDITIONAL REQUESTS RECORDED for the kitchen: "no allergies, no special instructions". ⏎ ORDER NOW: 1 x ਦਾਲ ਮੱਖਣੀ (Dal Makhani) [spicy]; 2 x ਬਟਰ ਨਾਨ (Butter Naan). total=$23.97 ⏎ GUIDE: acknowledge warmly in the customer's language, in your own words — do NOT re-ask about spice or allergies — then keep the order moving (pickup or delivery next if not set yet).
**SIERRA:** Alright, no allergies or special instructions noted. Would you like to pick up your order or have it delivered?

**USER:** Navdeep.
**SIERRA:** Thanks, Navdeep. Could I please have your phone number as well?
...
**SIERRA:** Thanks for that. Now, is this order for pickup or delivery?

**USER (reactive):** Delivery please.
**SIERRA:** Sure thing, delivery it is. Could you please provide the delivery address?
...
**SIERRA:** Thanks, Navdeep, and your phone number six four seven five five five one two one two is all set. Your delivery to 12 Main Street, Brampton is noted. Let me read back your order: one spicy Dal Makhani and two Butter Naan for delivery. Is everything correct?

**USER (reactive):** Delivery please.
**SIERRA:** Yes, your order is set for delivery. Just to confirm, one spicy Dal Makhani and two Butter Naan for delivery. Is that all correct?
...
**SIERRA:** So, to confirm, you have one spicy Dal Makhani and two Butter Naan, and this order is for delivery under the name Navdeep. Is everything correct?
