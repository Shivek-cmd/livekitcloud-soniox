...
> `add_item({"spice_level": "Medium", "item_query": "butter chicken", "quantity": 2})` → ADDED: 2 x Butter Chicken, note: medium. ⏎ ORDER NOW: 1 x ਗਾਰਲਿਕ ਨਾਨ (Garlic Naan); 2 x Butter Chicken [medium]. total=$44.97 ⏎ GUIDE: confirm the add in the customer's language — warm and in your own words, never reading these lines aloud — using the exact dish name and quantity above (quantity spoken as "two", never a digit), then keep the order moving.
...
**SIERRA:** Awesome, thank you. And will this be for pickup or delivery?
...
**SIERRA:** Alright, let me just make sure I've got your contact details right. I have your name down as Harpreet, spelled H-A-R-P-R-E-E-T, and your phone number as six, four, seven, three, zero, four, one, two, one, two. Is that all correct?
...
**SIERRA:** Perfect. Let me read your order back to you to make sure everything is correct. I have one Garlic Naan and two Butter Chicken, medium, for pickup under the name Harpreet. Is everything correct?
