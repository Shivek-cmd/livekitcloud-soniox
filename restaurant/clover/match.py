...
STOPWORDS: frozenset[str] = frozenset(
    {
        ...
        "haigi", "hai gi", "haiga", "hainge", "available",
        ...
        "ਕੋਲ", "ਹੈਗੀ", "ਹੈਗਾ", "ਹੈਗੇ", "ਨੇ", "ਅਵੇਲੇਬਲ",
        # Question/availability words — without these, "ਕੀ ਕੁਝ ਮਿਲ ਜਾਏਗਾ?"
        # scores ਮਿਲ against Malai Kofta and a browse turns into a dish pick.
        "ਤੁਹਾਡੇ", "ਤੁਸੀਂ", "ਕੀ", "ਮਿਲ", "ਮਿਲੇਗਾ", "ਮਿਲੇਗੀ", "ਮਿਲਦਾ", "ਮਿਲਦੀ",
        "ਜਾਏਗਾ", "ਜਾਵੇਗਾ", "ਕਿਹੜਾ", "ਕਿਹੜੀ", "ਸਕਦਾ", "ਸਕਦੀ",
        # Devanagari
        ...
        "तुम्हारे", "आपके", "आपका", "क्या", "मिल", "मिलेगा", "मिलेगी", "जाएगा",
        "कौन", "कौनसा", "सकता", "सकती",
    }
)
